...
CBOR = "82008200581ccb0ec2692497b458e46812c8a5bfa2931d1a2d965a99893828ec810f"
...
def new_default_cert():
    """Creates a default stake registration certificate for testing."""
    reader = CborReader.from_hex(CBOR)
    return StakeRegistrationCert.from_cbor(reader)


class TestStakeRegistrationCertNew:
    """Tests for StakeRegistrationCert.new() factory method."""

    def test_new_creates_valid_certificate(self):
        """Test creating a new stake registration certificate."""
    ...
    def test_new_with_none_raises_error(self):
        ...
        with pytest.raises((CardanoError, AttributeError)):
            StakeRegistrationCert.new(None)

    def test_new_with_invalid_type_raises_error(self):
        """Test that creating with invalid type raises error."""
        with pytest.raises(AttributeError):
            StakeRegistrationCert.new("not a credential")


class TestStakeRegistrationCertFromCbor:
    """Tests for StakeRegistrationCert.from_cbor() factory method."""

    def test_from_cbor_deserializes_certificate(self):
        """Test deserializing a certificate from CBOR."""
        reader = CborReader.from_hex(CBOR)
        cert = StakeRegistrationCert.from_cbor(reader)
    ...
    def test_from_cbor_with_invalid_credential_raises_error(self):
        ...
        reader = CborReader.from_hex("8200ef00581ccb0ec2692497b458e46812c8a5bfa2931d1a2d965a99893828ec810f")
        with pytest.raises(CardanoError):
            StakeRegistrationCert.from_cbor(reader)


class TestStakeRegistrationCertToCbor:
    """Tests for StakeRegistrationCert.to_cbor() method."""
    ...
    def test_to_cbor_roundtrip(self):
        ...
        cert2 = StakeRegistrationCert.from_cbor(reader)
...
class TestStakeRegistrationCertCredentialProperty:
    """Tests for StakeRegistrationCert.credential property."""
...
class TestStakeRegistrationCertToCip116Json:
    """Tests for StakeRegistrationCert.to_cip116_json() method."""
    ...
    def test_to_cip116_json_serializes_correctly(self):
        ...
        expected = '{"tag":"stake_registration","credential":{"tag":"pubkey_hash","value":"cb0ec2692497b458e46812c8a5bfa2931d1a2d965a99893828ec810f"}}'
        assert result == expected

    def test_to_cip116_json_includes_tag(self):
        """Test that JSON includes 'stake_registration' tag."""
        cert = new_default_cert()
        writer = JsonWriter()
        cert.to_cip116_json(writer)
        result = writer.encode()

        assert '"tag":"stake_registration"' in result
...
class TestStakeRegistrationCertLifecycle:
    ...
    def test_repr_returns_string(self):
        ...
        assert "StakeRegistrationCert" in result


class TestStakeRegistrationCertEdgeCases:
    ...
    def test_roundtrip_with_different_credentials(self):
        ...
        for cred_type in [CredentialType.KEY_HASH, CredentialType.SCRIPT_HASH]:
            ...
            cert1 = StakeRegistrationCert.new(credential)
